  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'pets().create',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.Pet\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val params: Pet = Pet.builder()\n        .name("doggie")\n        .addPhotoUrl("string")\n        .build()\n    val pet: Pet = client.pets().create(params)\n}',
      },
      go: {
        method: 'client.Pets.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpet, err := client.Pets.New(context.TODO(), emceesprodtesting5.PetNewParams{\n\t\tPet: emceesprodtesting5.PetParam{\n\t\t\tName:      "doggie",\n\t\t\tPhotoURLs: []string{"string"},\n\t\t},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pet.ID)\n}\n',
      },
      ruby: {
        method: 'pets.create',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'pets().findByStatus',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.Pet\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetFindByStatusParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val pets: List<Pet> = client.pets().findByStatus()\n}',
      },
      go: {
        method: 'client.Pets.FindByStatus',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpets, err := client.Pets.FindByStatus(context.TODO(), emceesprodtesting5.PetFindByStatusParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pets)\n}\n',
      },
      ruby: {
        method: 'pets.find_by_status',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'pets().findByTags',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.Pet\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetFindByTagsParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val pets: List<Pet> = client.pets().findByTags()\n}',
      },
      go: {
        method: 'client.Pets.FindByTags',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpets, err := client.Pets.FindByTags(context.TODO(), emceesprodtesting5.PetFindByTagsParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", pets)\n}\n',
      },
      ruby: {
        method: 'pets.find_by_tags',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'pets().retrieve',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example;\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient;\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient;\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.Pet;\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetRetrieveParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        MoreConflictingClient client = MoreConflictingOkHttpClient.fromEnv();\n\n        Pet pet = client.pets().retrieve(0L);\n    }\n}',
      },
      kotlin: {
        method: 'pets().retrieve',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.Pet\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetRetrieveParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val pet: Pet = client.pets().retrieve(0L)\n}',
      },
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'pets().delete',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example;\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient;\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient;\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        MoreConflictingClient client = MoreConflictingOkHttpClient.fromEnv();\n\n        client.pets().delete(0L);\n    }\n}',
      },
      kotlin: {
        method: 'pets().delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        ...
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example;\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient;\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient;\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetUploadImageParams;\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetUploadImageResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        MoreConflictingClient client = MoreConflictingOkHttpClient.fromEnv();\n\n        PetUploadImageResponse response = client.pets().uploadImage(\n          0L, "Example data"\n        );\n    }\n}',
      },
      kotlin: {
        method: 'pets().uploadImage',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetUploadImageParams\nimport com.configure_me_emcees_prod_testing_5.api.models.pets.PetUploadImageResponse\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val response: PetUploadImageResponse = client.pets().uploadImage(\n      0L, "Example data"\n    )\n}',
      },
      go: {
        method: 'client.Pets.UploadImage',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'store().orders().retrieve',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example;\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient;\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient;\nimport com.configure_me_emcees_prod_testing_5.api.models.Order;\nimport com.configure_me_emcees_prod_testing_5.api.models.store.orders.OrderRetrieveParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        MoreConflictingClient client = MoreConflictingOkHttpClient.fromEnv();\n\n        Order order = client.store().orders().retrieve(0L);\n    }\n}',
      },
      kotlin: {
        method: 'store().orders().retrieve',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.Order\nimport com.configure_me_emcees_prod_testing_5.api.models.store.orders.OrderRetrieveParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val order: Order = client.store().orders().retrieve(0L)\n}',
      },
      go: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      java: {
        method: 'store().orders().delete',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example;\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient;\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient;\nimport com.configure_me_emcees_prod_testing_5.api.models.store.orders.OrderDeleteParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        MoreConflictingClient client = MoreConflictingOkHttpClient.fromEnv();\n\n        client.store().orders().delete(0L);\n    }\n}',
      },
      kotlin: {
        method: 'store().orders().delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      go: {
        ...
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tuser, err := client.Users.New(context.TODO(), emceesprodtesting5.UserNewParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", user.ID)\n}\n',
      },
      ruby: {
        method: 'users.create',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'users().createWithList',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.users.User\nimport com.configure_me_emcees_prod_testing_5.api.models.users.UserCreateWithListParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val user: User = client.users().createWithList()\n}',
      },
      go: {
        method: 'client.Users.NewWithList',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tuser, err := client.Users.NewWithList(context.TODO(), emceesprodtesting5.UserNewWithListParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", user.ID)\n}\n',
      },
      ruby: {
        method: 'users.create_with_list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'users().login',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.users.UserLoginParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val response: String = client.users().login()\n}',
      },
      go: {
        method: 'client.Users.Login',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go"\n\t"github.com/stainless-sdks/emcees-prod-testing-5-go/option"\n)\n\nfunc main() {\n\tclient := emceesprodtesting5.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.Users.Login(context.TODO(), emceesprodtesting5.UserLoginParams{})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      ruby: {
        method: 'users.login',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      kotlin: {
        method: 'users().retrieve',
        example:
          'package com.configure_me_emcees_prod_testing_5.api.example\n\nimport com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClient\nimport com.configure_me_emcees_prod_testing_5.api.client.okhttp.MoreConflictingOkHttpClient\nimport com.configure_me_emcees_prod_testing_5.api.models.users.User\nimport com.configure_me_emcees_prod_testing_5.api.models.users.UserRetrieveParams\n\nfun main() {\n    val client: MoreConflictingClient = MoreConflictingOkHttpClient.fromEnv()\n\n    val user: User = client.users().retrieve("username")\n}',
      },
      go: {
