...
describe('resource data', () => {
  ...
  test.skip('destroy: only required params', async () => {
    const responsePromise = client.data.destroy({ objects: 'not_assets_liabilities' });
  ...
  test.skip('destroy: required and optional params', async () => {
    const response = await client.data.destroy({
  ...
  test.skip('purge', async () => {
    const responsePromise = client.data.purge();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('purge: request options and params are passed correctly', async () => {
